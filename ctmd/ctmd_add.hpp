...
inline constexpr void add_impl(const in_t &in, const out_t &out,
...
inline constexpr void add(const in1_t &in1, const in2_t &in2, out_t &out,
    ...
    case MPMode::NONE:
        core::batch<decltype(bexts)::rank(), MPMode::NONE>(
            detail::add_impl<decltype(ubin1), decltype(ubin2), decltype(ubout)>,
...
inline constexpr void add(const in_t &in, const val_t &val, out_t &out,
    ...
    case MPMode::NONE:
        core::batch<decltype(bexts)::rank(), MPMode::NONE>(
            detail::add_impl<decltype(ubin), decltype(ubout), val_t>,
